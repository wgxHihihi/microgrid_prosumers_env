...
def get_args():
    ...
    # Environment
    parser.add_argument("--seed", type=int, default=2234, help="seed")
    parser.add_argument("--scenario-name", type=str, default="model", help="name of the scenario script")
    parser.add_argument("--max-episode-len", type=int, default=96, help="maximum episode length")
    parser.add_argument("--episode", type=int, default=5000, help="number of episode")
    ...
    parser.add_argument("--evaluate-episode-len", type=int, default=96, help="length of episodes for evaluating")
    parser.add_argument("--evaluate", type=bool, default=False, help="whether to evaluate the model")
    parser.add_argument("--evaluate-rate", type=int, default=96, help="how often to evaluate model")
